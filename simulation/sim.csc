...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/project/contiki/rpl-border-router/border-router.c</source>
    ...
    <motetype>
      ...
      <description>llumination</description>
      <source>[CONTIKI_DIR]/project/contiki/nodes/illumination/illumination_node.c</source>
      <commands>make illumination_node.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/project/contiki/nodes/humidity/humidity_node.c</source>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <identifier>mtype457</identifier>
      <description>Temperature</description>
      <source>[CONTIKI_DIR]/project/contiki/nodes/temperature/temperature_node.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>50.21454746553735</x>
        <y>2.086410795749871</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>52.19668601635521</x>
        <y>41.40129250255209</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>85.72375978123192</x>
        <y>51.96996895530856</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>100.73006922939683</x>
        <y>32.81655082048281</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
      ...
      <motetype_identifier>mtype457</motetype_identifier>
    </mote>
  </simulation>
  <plugin>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.7597755016515915 0.0 0.0 1.7597755016515915 132.063016806882 154.99410606647632</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
